        ...
        <div class="container-fluid p-0 sm_padding_15px">
            <form method="post" action="{{ route('students.create') }}" enctype="multipart/form-data">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-6">
                        <div class="white_card card_height_100 mb_30">
                            ...
                            <div class="white_card_body">
                                <div class=" mb-0">
                                    <div class>
                                        <input type="text" class="form-control" placeholder="Enter Student's email" name="email" id="email" value="{{ old('email') }}">
                                        @error('email')
                                        <span class="text-danger ml-2" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                    ...
                    <div class="col-lg-6">
                        <div class="white_card card_height_100 mb_30">
                            ...
                            <div class="white_card_body">
                                <div class=" mb-0">
                                    <div class>
                                        <textarea class="form-control" name="address" id="address" placeholder="Enter Student's address"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-2">
                        <button type="submit" name="submit" class="btn btn-primary btn-block" style="width: 100%;">Create Student</button>
                    </div>
                </div>
            </form>
        </div>
