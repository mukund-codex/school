                    ...
                    <div class="col-lg-4">
                        <div class="white_card card_height_100 mb_30">
                            ...
                            <div class="white_card_body">
                                <div class=" mb-0">
                                    <div class>
                                        <input type="time" id="start_time" name="start_time" class="form-control" min="07:00" max="18:00" required>
                                        @error('start_time')
                                        <span class="text-danger ml-2" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                    ...
                    <div class="col-lg-4">
                        <div class="white_card card_height_100 mb_30">
                            ...
                            <div class="white_card_body">
                                <div class=" mb-0">
                                    <div class>
                                        <input type="time" id="end_time" name="end_time" class="form-control" min="07:00" max="18:00" required>
                                        @error('end_time')
                                        <span class="text-danger ml-2" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
