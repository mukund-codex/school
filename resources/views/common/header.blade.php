<head>
    ...
    <title>School</title>
    <link rel="icon" href="{{ asset('temps/img/logo.png') }}" type="image/png">

    <link rel="stylesheet" href="{{ asset('temps/css/bootstrap1.min.css') }}" />
    ...
    <link rel="stylesheet" href="{{ asset('temps/vendors/datatable/css/buttons.dataTables.min.css') }}" />

    <link rel="stylesheet" href="{{ asset('temps/vendors/text_editor/summernote-bs4.css') }}" />

    <link rel="stylesheet" href="{{ asset('temps/vendors/morris/morris.css') }}">

    <link rel="stylesheet" href="{{ asset('temps/vendors/material_icon/material-icons.css') }}" />

    <link rel="stylesheet" href="{{ asset('temps/vendors/calender_js/core/main.css') }}">
