                                ...
                                <div class="white_box_tittle list_header">
                                    ...
                                    <div class="box_right d-flex lms_block">
                                        ...
                                        <div class="add_button ms-2">
                                            <a href="{{ route('teacher.details.add', ['id' => request()->route()->parameter('id')]) }}" data-bs-toggle="modal" data-bs-target="#addcategory"
                                               class="btn_1">Add Teacher Details</a>
                                        </div>
                                        @endif
                                    </div>
                                </div>
                                    ...
                                    <table class="table lms_table_active ">
                                        ...
                                        @foreach($details as $detail)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('teacher.details.edit', ['id' => $detail['id']]) }}" class="btn btn-primary btn-rounded dark btn-sm">
                                                        <i class="las la-edit">Edit</i>
                                                    </a>

{{--                                                    <form method="POST" action="{{ route('teacher.delete', ['id' => $detail['id']]) }}">--}}
{{--                                                        @csrf--}}
{{--                                                        @method('DELETE')--}}
