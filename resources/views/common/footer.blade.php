        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="footer_iner text-center">
                    <p>2024 © Dashboard - Designed by <a href="#"> Mukunda Vishwakarma </a></p>
                </div>
            </div>
        </div>
    </div>
...
<script src="{{ asset('temps/js/jquery1-3.4.1.min.js') }}"></script>

<script src="{{ asset('temps/js/popper1.min.js') }}"></script>

<script src="{{ asset('temps/js/bootstrap.min.html') }}"></script>

<script src="{{ asset('temps/js/metisMenu.js') }}"></script>

<script src="{{ asset('temps/vendors/count_up/jquery.waypoints.min.js') }}"></script>

<script src="{{ asset('temps/vendors/chartlist/Chart.min.js') }}"></script>

<script src="{{ asset('temps/vendors/count_up/jquery.counterup.min.js') }}"></script>

<script src="{{ asset('temps/vendors/niceselect/js/jquery.nice-select.min.js') }}"></script>

<script src="{{ asset('temps/vendors/owl_carousel/js/owl.carousel.min.js') }}"></script>

<script src="{{ asset('temps/vendors/datatable/js/jquery.dataTables.min.js') }}"></script>
<script src="{{ asset('temps/vendors/datatable/js/dataTables.responsive.min.js') }}"></script>
<script src="{{ asset('temps/vendors/datatable/js/dataTables.buttons.min.js') }}"></script>
<script src="{{ asset('temps/vendors/datatable/js/buttons.flash.min.js') }}"></script>
<script src="{{ asset('temps/vendors/datatable/js/jszip.min.js') }}"></script>
<script src="{{ asset('temps/vendors/datatable/js/pdfmake.min.js') }}"></script>
<script src="{{ asset('temps/vendors/datatable/js/vfs_fonts.js') }}"></script>
...
<script src="{{ asset('temps/vendors/tagsinput/tagsinput.js') }}"></script>

<script src="{{ asset('temps/vendors/text_editor/summernote-bs4.js') }}"></script>
<script src="{{ asset('temps/vendors/am_chart/amcharts.js') }}"></script>

<script src="{{ asset('temps/vendors/scroll/perfect-scrollbar.min.js') }}"></script>
<script src="{{ asset('temps/vendors/scroll/scrollable-custom.js') }}"></script>
<script src="{{ asset('temps/vendors/chart_am/core.js') }}"></script>
<script src="{{ asset('temps/vendors/chart_am/charts.js') }}"></script>
<script src="{{ asset('temps/vendors/chart_am/animated.js') }}"></script>
<script src="{{ asset('temps/vendors/chart_am/kelly.js') }}"></script>
