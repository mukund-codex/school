...
<section class="main_content dashboard_part large_header_bg">
    ...
    <div class="main_content_iner ">
        <div class="container-fluid p-0 sm_padding_15px">
            <form method="post" action="{{ route('divisions.update', ['id' => $division['id']]) }}" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-lg-6">
                        <div class="white_card card_height_100 mb_30">
                            ...
                            <div class="white_card_body">
                                <div class=" mb-0">
                                    <div class>
                                        <input type="text" class="form-control" name="name" id="name" placeholder="Division Name" value="{{ $division['name'] }}" required>
                                        @error('name')
                                        <span class="text-danger ml-2" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
